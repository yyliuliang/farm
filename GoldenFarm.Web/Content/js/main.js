...
$(function () {
    ...
    $('.banner').backstretch([Host + "/content/images/banner01.jpg",Host + "/content/images/banner02.jpg"], {
        fade: 750,
        duration: 3000
    });

    $('.subbanner-news').backstretch([Host + "/content/images/banner-news01.png"], {
        fade: 750,
        duration: 3000
    });

    $('.subbanner-about').backstretch([Host + "/content/images/banner-about01.png",Host + "/content/images/banner-market01.png"], {
        fade: 750,
        duration: 3000
    });

    $('.subbanner-help').backstretch([Host + "/content/images/banner-about01.png"], {
        fade: 750,
        duration: 3000
    });

    $('.subbanner-farm').backstretch([Host + "/content/images/banner-farm01.jpg", Host + "/content/images/banner-farm02.jpg"], {
        fade: 750,
        duration: 3000
    });

    $('.subbanner-user').backstretch([Host + "/content/images/banner-user02.png", Host + "/content/images/banner-user01.png"], {
        fade: 750,
        duration: 3000
    });

    $('.subbanner-market').backstretch([Host + "/content/images/banner-market02.png", Host + "/content/images/banner-market01.png"], {
        fade: 750,
        duration: 3000
    });
