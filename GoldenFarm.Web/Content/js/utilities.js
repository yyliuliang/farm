...
var ScriptHelper = {
    ...
    ShowPageMask: function (ct) {
        ...
        var divMask = '<div class="submit_mask alpha60" style="position:absolute; top:0px; left:0px; text-align:center; display:none;"><div class="innercontainer alpha60yellow" style="margin:0 auto;border:1px solid #c6c6c6;width:99px; height:75px;"><img src="' + appPath + '/Content//content/images/loading.gif" width="100" alt=""/></div></div>';
        ...
        if (! -[1, ]) {
            submitMask.css("background", "url(" + appPath + "/content//content/images/blank.jpg_50.jpg) no-repeat -999px -999px;");
        }
        submitMask.show();
    },
